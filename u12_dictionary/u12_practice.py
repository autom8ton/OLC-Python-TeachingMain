...
# variable to remember the highest current number
...
print(f"Numbers {countAbove5000}")
...
students = {"Alice": 85, "Bob": 78, "Charlie": 92, "Diana": 99, "Eve": 76}



# Task 1: Identify and print the name of the highest scoring student.
maxscore = 0 # store the highest score
maxstudent = '' # store the highest student
